...
import { isPendingTxn, txnButtonText, txnButtonTextMultiType } from "../../slices/PendingTxnsSlice";
...
function Calculator() {
  ...
  const [jadeAmount, setJadeAmount] = useState(1);
  const [rewardYield, setRewardYield] = useState(1.029);
  const [purchasePrice, setPurchasePrice] = useState(283.88);
  const [marketPrice, setMarketPrice] = useState(2838.87);
            ...
            <div className="stake-top-metrics">
              <Grid container spacing={2}>
                <Grid item xs={12} md={4}>
                  <Typography variant="h5">Current D3 Price</Typography>
                  <Typography variant="h4">$282.66</Typography>
                </Grid>
                <Grid item xs={12} md={4}>
                  <Typography variant="h5">Current Reward Yield</Typography>
                  <Typography variant="h4">1.0272%</Typography>
                </Grid>
                <Grid item xs={12} md={4}>
                  <Typography variant="h5">Your Balance</Typography>
                  <Typography variant="h4">0 D3</Typography>
                </Grid>
              </Grid>
            </div>
          </Grid>
              ...
              <Grid container>
                <Grid item xs={12} sm={5}>
                  <Grid item xs={12} style={{ marginBottom: "16px" }}>
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="outlined-adornment-amount">3333 Amount</InputLabel>
                      <OutlinedInput
                        ...
                        endAdornment={
                          <InputAdornment position="end">
                            <div className="secondaryText">3333</div>
                          </InputAdornment>
                        }
                        label="sJADE Amount"
                      />
                  ...
                  <Grid item xs={12} style={{ marginBottom: "16px" }}>
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="outlined-adornment-yield">Reward Yield (%)</InputLabel>
                      <OutlinedInput
                  ...
                  <Grid item xs={12} style={{ marginBottom: "16px" }}>
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="outlined-adornment-purchase-price">JADE Purchase Price ($)</InputLabel>
                      <OutlinedInput
                        ...
                        label="D3 Purchase Price ($)"
                      />
                    </FormControl>
                  </Grid>
                  <Grid item xs={12}>
                    <FormControl fullWidth variant="outlined">
                      <InputLabel htmlFor="outlined-adornment-market-price">Future $D3 Market Price ($)</InputLabel>
                      <OutlinedInput
                ...
                <Grid item xs={12} sm={2}>
                  <div className="slider-box">
                    <Typography className="secondaryText">333 days</Typography>
                    <Slider
                      aria-label="Temperature"
                      orientation="vertical"
                      style={{ color: "#feb626", backgroundColor: "transparent" }}
                      size="small"
                    />
                  </div>
                </Grid>
                <Grid item xs={12} sm={5} className="calculator-value-box">
                  <Grid item className="calculator-value">
                    ...
                    <Typography variant="h5">$283.88</Typography>
                  </Grid>
                  <Grid item className="calculator-value">
                    <Typography variant="h6" className="secondaryText">
                      Current value
                    </Typography>
                    <Typography variant="h5">$283.89</Typography>
                  </Grid>
                  <Grid item className="calculator-value">
                    <Typography variant="h6" className="secondaryText">
                      D3 rewards estimate
                    </Typography>
                    <Typography variant="h5">0.03 D3</Typography>
                  </Grid>
                  <Grid item className="calculator-value">
                    <Typography variant="h6" className="secondaryText">
                      Potential future value
                    </Typography>
                    <Typography variant="h5">$2.9k</Typography>
                  </Grid>
                </Grid>
              </Grid>
            </div>
