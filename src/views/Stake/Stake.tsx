...
import ZapCta from "../AirDrop/ZapCta";
        ...
        <Paper className={`ohm-card`}>
          <Grid container direction="column" spacing={2}>
            <Grid item style={{ display: "flex" }}>
              ...
              <div className="card-header">
                <Typography variant="h5" component="h5" className="earning-day">
                  Your Earnings / Day
                </Typography>
                <Typography variant="h2" component="h2" className="earning-value">
                  $0
                </Typography>
              </div>
            </Grid>
              ...
              {!address ? (
                <div className="stake-wallet-notification">
                  ...
                  <Typography variant="h6">
                    <Trans>Connect your wallet to stake D3</Trans>
                  </Typography>
                </div>
              ) : (
                <>
