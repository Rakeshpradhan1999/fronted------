...
const darkTheme = {
  ...
  largeTextColor: "#feb626",
  activeLinkColor: "#F5DDB4",
  activeLinkSvgColor:
    "brightness(0) saturate(100%) invert(84%) sepia(49%) saturate(307%) hue-rotate(326deg) brightness(106%) contrast(92%)",
  primaryButtonColor: "#111",
  primaryButtonBG: "#feb626",
  primaryButtonHoverBG: "#feb626d7 ",
  secondaryButtonHoverBG: "rgba(54, 56, 64, 1)",
  outlinedPrimaryButtonHoverBG: "#feb626d7 ",
  outlinedPrimaryButtonHoverColor: "#fff",
  outlinedSecondaryButtonHoverBG: "transparent",
  outlinedSecondaryButtonHoverColor: "#feb626d7 ", //gold
